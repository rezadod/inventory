                ...
                <table id="datatable" class="table center-aligned-table">
                    ...
                    <tbody>
                        ...
                        <tr class="">
                            ...
                            @if(Auth::user()->role_id != '1')
                            {{-- <td><label class="badge <?php if($inv->status_barang == 0){ echo 'badge-success'; }else{ echo 'badge-danger';} ?>">{{ $inv->is_hapus }}</label>
                            </td> --}}
                            @endif
                            <td class="text-center">
                                <a href="#" class="m-2 btn btn-outline-primary btn-sm" onclick="detail({{$inv->id}})"
                                    data-toggle="modal" data-target="#detailModal">Detail</a>
                                {{-- <br> --}}
                                @if(Auth::user()->role_id == '1')
                                <a href="#" class="m-2 btn btn-outline-warning btn-sm" onclick="edit({{$inv->id}})"
                                    data-toggle="modal" data-target="#editModal">Edit</a>
                                {{-- <br> --}}
                                <a href="#" class="m-2 btn btn-outline-danger btn-sm" onclick="hapus({{$inv->id}})"
...
<!-- Modal Detail -->
<div class="modal" id="detailModal" tabindex="9999" role="dialog" aria-labelledby="detailModalLabel" aria-hidden="true">
