...
<form action="{{url('save_edit_barang')}}" method="post" enctype='multipart/form-data'>
   ...
   <div class="form-group row">
         ...
         <div class="col-sm-10">
            <input value="{{$inventory->nama_barang}}" type="text" class="form-control" id="edit_namaBarang" name="namaBarang" placeholder="Masukkan Nama Barang">
         </div>
   </div>
   <div class="form-group row">
   ...
   <div class="form-group row">
         <label for="keteranganBarang" class="col-sm-2 col-form-label">Keterangan</label>
         <div class="col-sm-10">
