        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-2">
                    ...
                    <div>
                        <a class="btn btn-warning btn-md text-white mt-2 btn-rounded" onclick="cari_data(2)"><i
            ...
            <form action="{{url('save_input_barang_keluar')}}" method="post" enctype='multipart/form-data'>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control" id="jumlah_barang_keluar"
                                name="jumlah_barang_keluar" placeholder="Masukkan Jumlah Barang">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                        <button type="button" class="btn btn-success text-white"
                            onclick="validate_input()">Simpan</button>
        ...
        if (nama_barang == '') {
            ...
            $.ajax({
                ...
                success: function (resp) {
                    ...
                    if (cek < 0) {
                        alert(
                            'Mohon Jumlah Barang Melebihi Stok Yang Tersedia, Silahkan Rubah Jumlah Sesuai Stok Yang Tersedia!');
                    } else {
                        $('#tombol_input').click();
                    }
                },
